...
%
% Parameterization: log transforms first hyperparameter (assumed to be precision),
...
htprs0 = regtools.transformhprs(hprs0,1);
...
hprsML = regtools.transformhprs(htprsML,-1);
logEv = -neglogEv2;
...
hprs = regtools.transformhprs(htprs,-1);
